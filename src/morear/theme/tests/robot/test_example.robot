...
#
#  $ bin/test -s morear.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src morear.theme.testing.MOREAR_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/morear/theme/tests/robot/test_example.robot
#
